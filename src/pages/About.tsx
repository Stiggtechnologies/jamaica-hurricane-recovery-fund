          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  The Jamaica Hurricane Recovery Fund was founded by <strong>Orville Davis</strong>, a Jamaican-born entrepreneur who has built a successful career in Alberta, Canada. Having witnessed the devastating impact of hurricanes on his homeland, Orville felt compelled to create a lasting solution that goes beyond immediate relief.
                </p>
                <p>
                  With deep roots in Jamaica and a global perspective gained through his work in Canada, Orville envisioned a fund that would not only help communities recover but also build long-term resilience against future climate challenges.
                </p>
                <p>
                  Through partnerships with Stigg Security Inc., Omega Group, and the Alberta Tech Team, Orville has assembled a coalition of experts and supporters committed to transparent, effective humanitarian work that honors Jamaica's strength and spirit.
                </p>
                <p className="text-jamaican-green font-semibold italic">
                  "Jamaica gave me my foundation. Now, it's time to help rebuild foundations for others."
                  <br />- Orville Davis
                </p>
              </div>
            </div>
